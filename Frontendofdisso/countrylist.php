...
html, body, #map-canvas2 { height: 50%; margin: 0; padding: 0;}
  ...
  echo $country;
        ...
        $result = mysqli_query($conn, "SELECT ip, longitude, latitude FROM IPDB WHERE IPDB.country = '$country';");           
...
*/
        ...
        $jsoniplonglat2 = json_encode($iplonglat2);
          ...
          $result3 = mysqli_query($conn, "SELECT ip, longitude, latitude FROM IPDB INNER JOIN IPTHREAT ON IPDB.ipID=IPTHREAT.ipID WHERE IPTHREAT.portscanthreat = 1 AND IPDB.country = '$country'; ; ");           
        ...
        $jsoniplonglat3 = json_encode($iplonglat3);
                  ...
                  $result4 = mysqli_query($conn, "SELECT ip, longitude, latitude FROM IPDB INNER JOIN IPTHREAT ON IPDB.ipID=IPTHREAT.ipID WHERE IPTHREAT.dosthreat = 1 AND IPDB.country = '$country'; ; ");           
