...
<!-- This needs to be button to search for database, should  send to search2 which queries database -->
    <h3> Search </h3>
      ...
      <input type="submit" value="Search DNS's ">
</form>
    <br>
<!-- This needs to be button to return chronological sort of IP's -->
    <h3> Sort IP's by Country</h3>
    <br>
<form action="countrylist.php" method="post">
    <select name="country"> <?php

                   include_once('connect.php');
        $result = mysqli_query($conn, "SELECT DISTINCT country FROM IPDB;");   
...
echo "</select>";
?>
     <input type="submit" value="Sort By Country">
</form>
